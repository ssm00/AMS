...
export default function StudentCardSelect({
  options,
}) {
  const people = [
    {
      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
        <div className="flex-auto p-4">
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative w-full h-4/5 cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
...
StudentCardSelect.defaultProps = {
  options: [
    { value: '1', label: '1회차' },
    { value: '2', label: '2회차' },
    { value: '3', label: '3회차' },
