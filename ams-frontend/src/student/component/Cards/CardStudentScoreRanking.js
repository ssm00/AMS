...
export default function CardStudentScoreRanking({examSubject}) {
              ...
              {data.map((scoreInfo) => {
                return(
                  <tr>
                    ...
                    {isFetched ? scoreInfo.examNumber : "-"}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                    {isFetched ? scoreInfo.rank : "-"}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <div className="flex items-center">
                        <span className="mr-2">{isFetched ? scoreInfo.score : ""}</span>
                        <div className="relative w-full">
                          <div className="overflow-hidden h-2 text-xs flex rounded bg-red-200">
                            <div
                              style={{ width: isFetched ? scoreInfo.score + "%" : "0%" }}
