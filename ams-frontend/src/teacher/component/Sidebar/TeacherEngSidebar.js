...
export default function TeacherEngSidebar() {
              ...
              <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                <li className="items-center">
                  <Link
                      className={
                          ...
                          (window.location.href.indexOf("/teacher/english/main") !== -1
                              ? "text-lightBlue-500 hover:text-lightBlue-600"
                              : "text-blueGray-700 hover:text-blueGray-500")
                      }
                      to="/teacher/english/main"
                  >
                    <i
                        className={
                ...
                <li className="items-center">
                  <Link
                      className={
                          "text-xs uppercase py-3 font-bold block " +
                          (window.location.href.indexOf("/teacher/english/answer") !== -1
                              ? "text-lightBlue-500 hover:text-lightBlue-600"
                              : "text-blueGray-700 hover:text-blueGray-500")
                      }
                      to="/teacher/english/answer"
                  >
                    <i
                        className={
                ...
                <li className="items-center">
                  <Link
                      className={
                          "text-xs uppercase py-3 font-bold block " +
                          (window.location.href.indexOf("/teacher/english/modify") !== -1
                              ? "text-lightBlue-500 hover:text-lightBlue-600"
                              : "text-blueGray-700 hover:text-blueGray-500")
                      }
                      to="/teacher/english/modify"
                  >
                    <i
                        className={
                            "fas fa-tv mr-2 text-sm " +
